    ...
    def __get_svg(self, main_color: str, accent_color: str) -> str:
        ...
        return dedent("""
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45">
              <g fill="{0}" fill-rule="evenodd" stroke="{1}" stroke-linecap="round" stroke-linejoin="round"
                  stroke-width="1.5">
                ...
                <path d="M12.5 37c5.5 3.5 14.5 3.5 20 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16
                      4V27v-3.5c-2.5-7.5-12-10.5-16-4-3 6 6 10.5 6 10.5v7"/>
